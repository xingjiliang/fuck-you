...
def main(_):
    ...
    global_config.batch_size = 65536
...
def _define_flags():
    flags.DEFINE_string(name="application_name", short_name="a", default="aaa", help="模型参数代号")
    flags.DEFINE_string(name="model_name", short_name="m", default="fnn", help="选择models目录下的模型")
    ...
    flags.DEFINE_string(name="feature_config_file", short_name="f", default="im_features_only_continuous.json", help="特征配置文件")
